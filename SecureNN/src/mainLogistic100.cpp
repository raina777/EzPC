...
auto tmp3 = make_vector<int64_t>( (int32_t)784,  (int32_t)10);

auto tmp4 = make_vector<uint64_t>( (int32_t)784,  (int32_t)10);

auto tmp5 = make_vector<int64_t>( (int32_t)10);

auto tmp6 = make_vector<uint64_t>( (int32_t)10);

auto tmp7 = make_vector<uint64_t>( (int32_t)100,  (int32_t)10);

auto tmp8 = make_vector<uint64_t>( (int32_t)100,  (int32_t)10);

auto tmp9 = make_vector<uint64_t>( (int32_t)100);

auto tmp0 = make_vector<uint64_t>( (int32_t)100,  (int32_t)784);
/* Variable to read the clear value corresponding to the input variable tmp0 at (394,1-394,41) */
...
auto tmp1 = make_vector<uint64_t>( (int32_t)784,  (int32_t)10);
/* Variable to read the clear value corresponding to the input variable tmp1 at (397,1-397,40) */
...
auto tmp2 = make_vector<uint64_t>( (int32_t)10);
/* Variable to read the clear value corresponding to the input variable tmp2 at (400,1-400,35) */
...
start_m();
CreateTensor2( (int32_t)784,  (int32_t)10,  (int64_t)3276, tmp3);
CreateIdentity22( (int32_t)784,  (int32_t)10, tmp1, tmp4);
CreateTensor1( (int32_t)10,  (int64_t)6553, tmp5);
CreateIdentity11( (int32_t)10, tmp2, tmp6);
MatMulCSF2D( (int32_t)100,  (int32_t)784,  (int32_t)10, tmp0, tmp4, tmp7,  (int64_t)15);
MatAddBroadCast2( (int32_t)100,  (int32_t)10, tmp7, tmp6, tmp8);
ArgMax1( (int32_t)100,  (int32_t)100,  (int32_t)10, tmp8,  (int32_t)1, tmp9);
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)100; i0++){
add_to_output_queue(out_q, funcReconstruct2PCCons(tmp9[i0], 1), SERVER, cout);
}
end_m(whichNetwork);
