...
auto tmp7 = make_vector<uint64_t>( (int32_t)1,  (int32_t)10);

auto tmp8 = make_vector<uint64_t>( (int32_t)1,  (int32_t)10);

auto tmp9 = make_vector<uint64_t>( (int32_t)1);

auto tmp0 = make_vector<uint64_t>( (int32_t)1,  (int32_t)784);
/* Variable to read the clear value corresponding to the input variable tmp0 at (394,1-394,39) */
...
MatMulCSF2D( (int32_t)1,  (int32_t)784,  (int32_t)10, tmp0, tmp4, tmp7,  (int64_t)15);
MatAddBroadCast2( (int32_t)1,  (int32_t)10, tmp7, tmp6, tmp8);
ArgMax1( (int32_t)1,  (int32_t)1,  (int32_t)10, tmp8,  (int32_t)1, tmp9);
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
