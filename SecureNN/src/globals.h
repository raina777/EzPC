...
//#define F_SECUREMLNN_SQ
#define F_SECUREMLNN_RELU
...
//#define RUN_MSB_OPTI
//#define CONV_OPTI //Toggle between old or new convolution
//#define PRECOMPUTEAES
//#define PARALLIZE_CRITICAL

//NOTE : Other optimizations include changing prime number from 67 to 251. 
//If ever needing to list down all optimizations done, check diff with master version.

#endif

//To test the implementation
#define USE_CONV_2DCSF
